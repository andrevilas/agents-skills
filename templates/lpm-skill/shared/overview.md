...
Skill canônica para `__WORKFLOW_SCOPE__` sobre o MCP `lpm`.

## Objetivo

Transformar o agente em um operador capaz de:

- executar `__WORKFLOW_SCOPE__` com clareza operacional
...
- reusable agent adapters

## Princípios

- inspecionar contexto antes de mutar estado

...
| `aish-governed-development-operator` | `1.1.0` | `9995e8ef2dc2678c2b367ee6ef0471fe26145b7a1e2c45b103c3651a18ea3847` |
...
- Behavioral contract validation passed for terminal-state convergence,
  ...
  reconciliation, composite health, orchestrated closure, and post-unarchive
  preflight.
